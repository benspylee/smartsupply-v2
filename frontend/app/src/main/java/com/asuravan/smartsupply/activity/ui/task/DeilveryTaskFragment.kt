...
import com.asuravan.smartsupply.activity.ui.task.DeliveryAcceptanceFragment
...
class DeilveryTaskFragment : CommonFragment() {
    ...
    fun loadItems(reload:Boolean = true) {
        ...
        val call = orderService.getOrderByTransporter(appusercd!!)
            ...
            inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
                ...
                init {
                    ...
                    itemView.setOnClickListener {
                        ...
                        val fragmentGet = DeliveryAcceptanceFragment()
